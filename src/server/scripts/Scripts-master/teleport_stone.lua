    ...
    player:GossipMenuAddItem(9, "|cFF191970Go Home!|r", 0,  1000)
    ...
    if (intid == 1000) then
        --if (player:IsInCombat() == true) then
             --player:SendAreaTriggerMessage("U can't use this while u are in combat!")
        --else
             player:CastSpell(0, 8690, 1)
        --end
        --player:ResetSpellCooldown(8690, 1)
    end
    ...
    if (intid == 5) then -- Outland Locations
            player:GossipMenuAddItem(2, "|cFF191970Shattrath City|r", 0,  11)
